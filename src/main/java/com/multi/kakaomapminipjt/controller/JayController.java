...
public class JayController {
    ...
    public class MapJYRController {
        ...
        public ResponseEntity<List<String>> searchImages(@RequestParam String keyword) {
            // 프론트 fetchImage()가 배열을 기대하므로 맞춰서 반환
            return ResponseEntity.ok(
                    jayService.findImageUrlByKeyword(keyword)
                            .map(List::of)
                            .orElseGet(List::of)
            );
        }
    ...
    @GetMapping("/jayTravel/searchImages")
